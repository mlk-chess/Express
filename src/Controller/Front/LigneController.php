...
class LigneController extends AbstractController
{
    ...
    {
        return $this->render('Front/ligne/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->renderForm('Front/ligne/new.html.twig', [
            'ligne' => $ligne,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('Front/ligne/show.html.twig', [
            'ligne' => $ligne,
        ]);
    }
    ...
    public function edit(Request $request, Ligne $ligne): Response
    {
        ...
        return $this->renderForm('Front/ligne/edit.html.twig', [
            'ligne' => $ligne,
            'form' => $form,
        ]);
    }
